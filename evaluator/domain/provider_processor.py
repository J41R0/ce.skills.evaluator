...
STACK_EXC_REPUTATION_LAMBDA = functions.Activation.sigmoid_hip_lambda(STACK_EXCHANGE_MAX_REPUTATION_CONTRIBUTION,
                                                                           0.98)
STACK_EXC_SCORE_LAMBDA = functions.Activation.sigmoid_hip_lambda(STACK_EXCHANGE_MAX_SCORE_CONTRIBUTION, 0.98)
